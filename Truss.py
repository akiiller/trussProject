...
def definir_geometria():
    ...
    # Mínimo de 12 barras para 1 integrante (10 + 2*1)
    bars = np.array([
        [0, 1], [1, 2], [2, 3], [3, 4],  # Banzos inferiores
        [5, 6], [6, 7],  # Banzos superiores
        [0, 5], [1, 5], [2, 5],  # Diagonais e montantes esquerdos
        [2, 6], [2, 7], [3, 7],  # Diagonais e montantes centrais e direitos
        [4, 7]  # Montante direito
    ])
